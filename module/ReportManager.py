...
class ReportManager(QDialog):
    ...
    def setupUI(self):
        ...
        self.resize(425, 487)
        self.setWindowTitle(QtGui.QApplication.translate("self", "报告管理", None, QtGui.QApplication.UnicodeUTF8))
        self.groupBox = QtGui.QGroupBox(self)
        self.groupBox.setGeometry(QtCore.QRect(10, 10, 271, 461))
        self.groupBox.setTitle(QtGui.QApplication.translate("self", "报告列表", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.groupBox_2.setTitle(QtGui.QApplication.translate("self", "设置报告", None, QtGui.QApplication.UnicodeUTF8))
        self.groupBox_2.setObjectName(_fromUtf8("groupBox_2"))
        self.reportButton = QtGui.QPushButton(self.groupBox_2)
        self.reportButton.setGeometry(QtCore.QRect(20, 30, 75, 23))
        self.reportButton.setText(QtGui.QApplication.translate("self", "设置", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.reportupdateButton.setText(QtGui.QApplication.translate("self", "报告入库", None, QtGui.QApplication.UnicodeUTF8))
