...
class TemplateManager(object):
    def setupUi(self, Dialog):
        ...
        Dialog.setWindowTitle(QtGui.QApplication.translate("Dialog", "模板管理", None, QtGui.QApplication.UnicodeUTF8))
        self.groupBox = QtGui.QGroupBox(Dialog)
        self.groupBox.setGeometry(QtCore.QRect(10, 10, 271, 461))
        self.groupBox.setTitle(QtGui.QApplication.translate("Dialog", "模板列表", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.groupBox_2.setTitle(QtGui.QApplication.translate("Dialog", "设置模板", None, QtGui.QApplication.UnicodeUTF8))
        self.groupBox_2.setObjectName(_fromUtf8("groupBox_2"))
        self.templateButton = QtGui.QPushButton(self.groupBox_2)
        self.templateButton.setGeometry(QtCore.QRect(20, 30, 75, 23))
        self.templateButton.setText(QtGui.QApplication.translate("Dialog", "设置", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.templateupdateButton.setText(QtGui.QApplication.translate("Dialog", "模板入库", None, QtGui.QApplication.UnicodeUTF8))
